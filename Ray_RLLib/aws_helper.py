...
if __name__ == "__main__":
    ...
    argparser.add_argument(
        "action",
        type=str,
        choices=["create-image", "start", "launch", "get", "put", "exec", "stop"],
        help="",
    )
    argparser.add_argument("--instance-id", type=str, help="", default="")
    # create image arguments
    argparser.add_argument("--name", type=str, default="CARLA_RLLIB_3")
