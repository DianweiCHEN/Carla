...
def main():
    ...
    try:
        ...
        car_tr = carla.Transform(carla.Location(x=235.75, y=125, z=0.9), carla.Rotation(yaw=-88.5))
        ...
        print("Steer!!!!")
        for i in range(0, 7):
            wait(world, 1, sensor_queue, sensor_list)
        ...
        actor.enable_constant_velocity(carla.Vector3D(00, 0, 0))
